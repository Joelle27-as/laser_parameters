# Final app update with accurate pulse rendering using dynamic resolution
...
st.markdown("Calculate fluence, power, exposure metrics, compare to tissue thresholds, and visualize thermal dynamics for any number of pulses.")
...
N = st.sidebar.number_input("Number of Pulses", value=10, min_value=1)
...
def simulate(N, f, tau, E, A, cooling_coef=0.05):
    ...
    t_res = min(tau / 10, interval / 20)  # ensure enough resolution
